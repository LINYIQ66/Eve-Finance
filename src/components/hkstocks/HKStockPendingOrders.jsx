...
export default function HKStockPendingOrders({ transactions = [], onRefresh, livePrice, allPrices = {} }) {
  ...
  const pendingOrders = transactions.filter(t => {
    ...
    return meta.symbol && meta.side && meta.limitPrice && isHKStock(meta.symbol.toLowerCase());
  });
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="text-xs text-slate-500 space-y-0.5">
                              <div className="flex flex-wrap gap-x-3 gap-y-0.5">
                                ...
                                <span>限价 @ <strong className="text-slate-700">${displayPrice.toFixed(3)}</strong></span>
                                {orderMarketPrice && (
                                  <>
                                    <span className="text-slate-300">|</span>
                                    <span>市价 <strong className={orderMarketPrice >= displayPrice ? "text-green-600" : "text-red-500"}>HK${orderMarketPrice.toFixed(3)}</strong></span>
                                  </>
                                )}
                              </div>
                            ...
                            <div className="flex gap-2 items-start">
                              ...
                              <div className="flex gap-1.5 flex-shrink-0">
                                <Button
                                  ...
                                  disabled={isSaving}
                                  className="h-8 px-3 bg-red-600 hover:bg-red-700 text-xs gap-1"
                                >
                                  {isSaving
